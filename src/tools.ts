...
import { configureEnvironmentTools } from "./tools/environments.js";
...
function configureAllTools(server: McpServer, tokenProvider: () => Promise<string>, connectionProvider: () => Promise<WebApi>, userAgentProvider: () => string, enabledDomains: Set<string>) {
  ...
  configureIfDomainEnabled(Domain.ENVIRONMENTS, () => configureEnvironmentTools(server, tokenProvider, connectionProvider, userAgentProvider));
